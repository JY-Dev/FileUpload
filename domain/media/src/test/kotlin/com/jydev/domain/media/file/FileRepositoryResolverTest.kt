...
import com.jydev.domain.media.file.infra.FileRepositoryResolver
...
class FileRepositoryResolverTest {
    ...
    val fileRepositoryResolver = FileRepositoryResolver(fileRepositoryList)
